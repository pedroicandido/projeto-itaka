...
export const LOADING_OPTIONS_SCHOOLING = "LOADING_OPTIONS_SCHOOLING";
export const ON_FETCH_SCHOOLING_FAIL = "ON_FETCH_SCHOOLING_FAIL";
...
export const ON_FETCH_PERSON_FAIL = "ON_FETCH_PERSON_FAIL";

export const SET_NEW_PERSON = "SET_NEW_PERSON";

//school

export const SET_SEARCH_SCHOOL = "SET_SEARCH_SCHOOL";
export const LOADING_SCHOOL = "LOADING_SCHOOL";
export const ON_FETCH_SCHOOL_FAIL = "ON_FETCH_SCHOOL_FAIL";
