...
const Dashboard = () => {
    ...
    },
    {
      ...
      options: {
        ...
        customBodyRender: (value) => {
          ...
          return (
            <>
              <Badge color={color} variant="dot" badgeContent="" /> <span style={{ marginLeft: 5 }}>{value}</span>
            </>
          )
        }
      },
  ...
  const dataTable = [
    ...
    { name: "Capoeira", company: "Joel do Borel", status: "Férias", state: "FL" },
          ...
          <Grid container>
            <Grid item xl={12} lg={12}>
              <Grid container justify="space-between" alignItems="center">
                <Typography style={{ marginLeft: 20, fontWeight: 'bold', fontSize: 14 }}>Alunos Novos</Typography>
                <IconButton >
                  <RotateRightIcon />
                </IconButton>
              </Grid>
      ...
      <Grid item xl={2} lg={2}>
        <Card className={classes.card}>
          <Grid container>
            <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
              <Grid container justify="space-between" alignItems="center">
                <Typography style={{ marginLeft: 20, fontWeight: 'bold', fontSize: 14 }}>Média de idade dos alunos</Typography>
                <IconButton >
                  <RotateRightIcon />
                </IconButton>
              </Grid>
